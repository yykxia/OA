...
{
    public partial class Fines_sub : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                loadInfo(userId);
                //
                loadFlowInfo("OA_Fines_Main", userId);
                //
                bindProj();
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlCmd += "('" + GetUser() + "','" + DateTime.Now + "','" + numbbox_total.Text.Trim() + "','" + ddl_flow.SelectedValue + "','" + stepId + "','" + txa_reason.Text + "','" + ddl_proj.SelectedValue + "','"+txa_empList.Text+"','"+txa_proveList.Text+"')";

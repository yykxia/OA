<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA_UseStamp_Main_m.aspx.cs" Inherits="WX2HK.admin.OA_UseStamp_Main_m" %>
...
<%--                        <f:BoundField DataField="dealAdc" HeaderText="意见" ExpandUnusedSpace="true"></f:BoundField>--%>
    ...
    <script>
        wx.config({
            ...
            timestamp: '<%= UseStamp_TimeStamp %>', // 必填，生成签名的时间戳
            nonceStr: '<%= UseStamp_Nonce %>', // 必填，生成签名的随机串
            signature: '<%= UseStamp_MsgSig %>',// 必填，签名，见附录1

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptMgmt.aspx.cs" Inherits="WX2HK.admin.DeptMgmt" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" runat="server" />
        <f:Grid ID="Grid1" runat="server" ShowHeader="false" OnRowCommand="Grid1_RowCommand"
            ...
            <Columns>
                <f:RenderField DataField="deptName" ColumnID="deptName" HeaderText="部门名称" Width="200px">
                    <Editor>
                        <f:TextBox ID="tbxEditordeptName" Required="true" runat="server">
                        </f:TextBox>
                    </Editor>                
                </f:RenderField>
                <f:RenderField DataField="deptDesc" ColumnID="deptDesc" HeaderText="描述" ExpandUnusedSpace="true">
                    <Editor>
                        <f:TextBox ID="tbxEditordeptDesc" runat="server">
                        </f:TextBox>
                    </Editor>                
                </f:RenderField>

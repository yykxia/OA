<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA_Fines_Main.aspx.cs" Inherits="WX2HK.admin.OA_Fines_Main" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="100px" AutoScroll="true"
            ...
            <Items>
                ...
                <f:Label ID="label_obj" runat="server" Label="处罚对象"></f:Label>
                <f:Label ID="label_total" runat="server" Label="罚款金额"></f:Label>
                <f:Label ID="label_proveEmp" runat="server" Label="证明人"></f:Label>
                <f:Label ID="label_reason" runat="server" Label="情况说明"></f:Label>    

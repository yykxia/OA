<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA_Car_Main_m.aspx.cs" Inherits="WX2HK.admin.OA_Car_Main_m" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="100px" AutoScroll="true"
            ...
            <Items>
                ...
                <f:Label ID="label_projName" runat="server" Label="关联项目"></f:Label>
                <f:Label ID="label_carName" runat="server" Label="所用车辆"></f:Label>
                <f:Label ID="label_curMileage" runat="server" Label="当前里程"></f:Label>
                <f:Label ID="label_toWhere" runat="server" Label="目的地"></f:Label>
                <f:Label ID="label_withWho" runat="server" Label="证明人"></f:Label>
                <f:Label ID="label_strTime" runat="server" Label="借用时间"></f:Label>
                <f:Label ID="label_endTime" runat="server" Label="返还时间"></f:Label>
...
<%--                        <f:BoundField DataField="dealAdc" HeaderText="意见" ExpandUnusedSpace="true"></f:BoundField>--%>
    ...
    <script>
        ...
        wx.config({
            ...
            timestamp: '<%= CarMgmt_TimeStamp %>', // 必填，生成签名的时间戳
            nonceStr: '<%= CarMgmt_Nonce %>', // 必填，生成签名的随机串
            signature: '<%= CarMgmt_MsgSig %>',// 必填，签名，见附录1

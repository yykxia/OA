<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseStamp_AdminRegister.aspx.cs" Inherits="WX2HK.Contracts.UseStamp_AdminRegister" %>
        ...
        <f:Grid ID="Grid1" runat="server" ShowHeader="false">
            <Columns>
                ...
                <f:WindowField ColumnID="myWindowField" Width="80px" TextAlign="Center" WindowID="Window1" HeaderText="登记信息"
                    ...
                    DataIFrameUrlFormatString="UseStamp_AdminRegister_Edit.aspx?id={0}" />
            </Columns>
        </f:Grid>
    </form>

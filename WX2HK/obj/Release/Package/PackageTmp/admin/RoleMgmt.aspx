...
<body>
    ...
    <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="Grid1" />
        <f:Grid ID="Grid1" runat="server" ShowHeader="false" OnRowCommand="Grid1_RowCommand"
            ...
            <Columns>
                <f:RenderField DataField="roleName" ColumnID="roleName" HeaderText="角色名称" Width="200px">
                    <Editor>
                        <f:TextBox ID="tbxEditorRoleName" Required="true" runat="server">
                        </f:TextBox>
                    </Editor>                
                </f:RenderField>
                <f:RenderField DataField="roleDesc" ColumnID="roleDesc" HeaderText="角色描述" ExpandUnusedSpace="true">
                    <Editor>

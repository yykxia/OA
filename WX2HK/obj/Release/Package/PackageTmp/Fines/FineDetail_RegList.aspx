<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FineDetail_RegList.aspx.cs" Inherits="WX2HK.Fines.FineDetail_RegList" %>
...
<%--                                        <f:Button ID="btn_uploadDateFilter" runat="server" Text="筛选"
        ...
        <%--            <Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="fineAmount" ColumnID="billTotal" HeaderText="处罚金额" Width="100px" TextAlign="Center"></f:BoundField>
                        <f:WindowField ColumnID="myWindowField" Width="60px" WindowID="Window1" HeaderText="查看"
                            ...
                            DataIFrameUrlFormatString="Fines_RegList_Details.aspx?tabId={0}" />
                    </Columns>
        </f:Grid>

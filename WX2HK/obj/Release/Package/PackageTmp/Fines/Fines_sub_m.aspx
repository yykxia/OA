<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fines_sub_m.aspx.cs" Inherits="WX2HK.Fines.Fines_sub_m" %>
...
<%--                <f:TextBox ID="txb_payeeName" runat="server" Label="收款方"></f:TextBox>--%>
                <f:DropDownList ID="ddl_flow" runat="server" Label="选择流程" LabelAlign="Top"
...
<%--                <f:Button ID="btn_objects" Text="处罚对象 " runat="server" OnClick="btn_objects_Click"></f:Button>--%>
                <f:TextArea ID="txa_empList" runat="server" Label="处罚对象" LabelAlign="Top"></f:TextArea>
                <f:NumberBox ID="numbbox_total" runat="server" Label="罚款金额(元)" DecimalPrecision="2" LabelAlign="Top"></f:NumberBox>
                <f:TextArea ID="txa_reason" runat="server" Label="补充说明" AutoGrowHeight="true" LabelAlign="Top"></f:TextArea>
<%--                <f:Button ID="btn_provf" Text="添加证明人 " runat="server" OnClick="btn_provf_Click"></f:Button>--%>
                ...
                <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                    <Items>
                        ...
                        <f:Button runat="server" ID="btnSubmit" Width="60px" OnClick="btnSubmit_Click"
                               ValidateForms="SimpleForm1" Text="提交" ConfirmText="确认提交？">
                        </f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
    ...
    <script>
        ...
        wx.config({
            ...
            timestamp: '<%= FineSub_TimeStamp %>',// 必填，生成签名的时间戳
            nonceStr: '<%= FineSub_Nonce %>', // 必填，生成签名的随机串
            signature: '<%= FineSub_MsgSig %>',// 必填，签名，见附录1

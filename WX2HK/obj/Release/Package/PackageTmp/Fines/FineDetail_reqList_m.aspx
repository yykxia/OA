<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FineDetail_reqList_m.aspx.cs" Inherits="WX2HK.Fines.FineDetail_reqList_m" %>
        ...
        <f:Grid ID="Grid1" runat="server" ShowHeader="false">
            <Columns>
                ...
                <f:TemplateField HeaderText="" Width="50px">
                    <ItemTemplate>
                        <a href='<%#"Fines_RegList_Details_m.aspx?tabId="+ Eval("id")%>'>查看</a>
                    </ItemTemplate>
                </f:TemplateField>
            </Columns>
        </f:Grid>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment_ReqList_m.aspx.cs" Inherits="WX2HK.Payment.Payment_ReqList_m" %>
        ...
        <f:Grid ID="Grid1" runat="server" ShowHeader="false">
            <Columns>
                ...
                <f:TemplateField HeaderText="" Width="50px">
                    <ItemTemplate>
                        <a href='<%#"Payment_RegList_Details_m.aspx?tabId="+ Eval("id")%>'>查看</a>
                    </ItemTemplate>
                </f:TemplateField>
            </Columns>
        </f:Grid>

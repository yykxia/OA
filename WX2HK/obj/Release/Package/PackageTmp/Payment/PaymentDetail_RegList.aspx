<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentDetail_RegList.aspx.cs" Inherits="WX2HK.Payment.PaymentDetail_RegList" %>
            ...
            <Items>
                <f:Form ID="SimpleForm1" runat="server" Height="150px" BodyPadding="10px">
                    <Rows>
                        ...
                        <f:FormRow>
                            <Items>
                                <f:DatePicker runat="server" EnableEdit="false" Label="日期从" EmptyText="请选择日期"
                                    ID="DatePicker1">
                                </f:DatePicker>
...
<%--                                        <f:Button ID="btn_uploadDateFilter" runat="server" Text="筛选"
                        ...
                        <f:Toolbar runat="server" ID="tlb_upload" Position="Bottom">
                            <Items>
                                <f:Button ID="btn_mutiSeach" runat="server" Text="综合查询" Icon="SystemSearch"
                                        ValidateForms="SimpleForm1" OnClick="btn_mutiSeach_Click"></f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>          
                </f:Form>        
        ...
        <%--            <Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="projName" HeaderText="关联项目" Width="120px"></f:BoundField>
                        <f:BoundField DataField="reqDte" HeaderText="日期" Width="100px" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center"></f:BoundField>
                        <f:BoundField DataField="payTotal" ColumnID="payTotal" HeaderText="付款金额" Width="100px" TextAlign="Center"></f:BoundField>
                        <f:WindowField ColumnID="myWindowField" Width="60px" WindowID="Window1" HeaderText="查看"
                            ...
                            DataIFrameUrlFormatString="Payment_RegList_Details.aspx?tabId={0}" />
                    </Columns>
        </f:Grid>

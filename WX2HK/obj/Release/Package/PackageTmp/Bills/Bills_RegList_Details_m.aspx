<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bills_RegList_Details_m.aspx.cs" Inherits="WX2HK.Bills.Bills_RegList_Details_m" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="120px" AutoScroll="true"
            ...
            <Items>
                ...
                <f:Label ID="label_proj" runat="server" Label="相关项目" LabelAlign="Top"></f:Label>

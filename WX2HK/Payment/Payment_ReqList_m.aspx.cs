...
{
    public partial class Payment_ReqList_m : System.Web.UI.Page
    {
        ...
        {
            string sqlCmd = "select A.*,isnull(B.stepName,'已完成') as checkStatus,C.flowName from OA_PayMent_Main A";

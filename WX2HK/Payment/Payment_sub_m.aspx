<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment_sub_m.aspx.cs" Inherits="WX2HK.Payment.Payment_sub_m" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="100px" AutoScroll="true"
            ...
            <Items>
                ...
                <f:NumberBox ID="numbbox_total" Required="true" runat="server" Label="付款金额(元)"
                     LabelAlign="Top" DecimalPrecision="2" ShowRedStar="true"></f:NumberBox>
                <f:RadioButtonList ID="rdb_payType" runat="server" Label="类型">
                    <f:RadioItem Text="预付" Value="0" />
                    <f:RadioItem Text="应付" Value="1" />
                </f:RadioButtonList>
                <f:TextArea ID="txa_reason" runat="server" Label="补充说明" LabelAlign="Top" AutoGrowHeight="true"></f:TextArea>
    ...
    <script>
        ...
        wx.config({
            ...
            timestamp: '<%= Payment_TimeStamp %>',// 必填，生成签名的时间戳
            nonceStr: '<%= Payment_Nonce %>', // 必填，生成签名的随机串
            signature: '<%= Payment_MsgSig %>',// 必填，签名，见附录1

...
{
    public partial class PaymentDetail_RegList : BasePage
    {
        ...
        private void bindGrid(string reqMan, string dt1, string dt2)
        {
            ...
            if (!string.IsNullOrEmpty(dt1))
            {
                ...
                {
                    sqlCmd = "select A.*,B.chineseName,C.projName from OA_PayMent_Main A left join OA_Sys_EmployeeInfo B on A.reqMan=B.id";
        ...
        //        {
        //            BillSum += Convert.ToDecimal(row["payTotal"]);
        //        }

        //        summary.Add("payTotal", BillSum);
        //        Grid1.SummaryData = summary;
        //    }
        //    else
        //    {
        //        summary.Add("payTotal", 0);
        //        Grid1.SummaryData = summary;
        //    }
        //}

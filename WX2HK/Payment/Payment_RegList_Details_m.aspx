<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment_RegList_Details_m.aspx.cs" Inherits="WX2HK.Payment.Payment_RegList_Details_m" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="120px" AutoScroll="true"
            ...
            <Items>
                ...
                <f:Label ID="label_payTotal" runat="server" Label="付款金额"></f:Label>
                <f:Label ID="label_type" runat="server" Label="付款类型"></f:Label>

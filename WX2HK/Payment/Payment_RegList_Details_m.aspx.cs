...
{
    public partial class Payment_RegList_Details_m : System.Web.UI.Page
    {
        ...
        {
            string sqlCmd = "select A.*,c.chineseName,d.deptName,t.projName,(case when isAdvPay='0' then '预付' else '应付' end) as payType from OA_PayMent_Main A left join OA_Sys_step_empList B on B.formId=A.id";

...
<%--                        <f:HyperLinkField DataTextField="viewTyp" DataTextFormatString="{0}" ExpandUnusedSpace="true" Target="_self"
                            DataNavigateUrlFields="tabId,linkPage" DataNavigateUrlFormatString="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc1c3336a5eeb57ea&redirect_uri=http%3a%2f%2foa.mlily.com%3a30020%2fCheckOut%2f{1}.aspx?mainId={0}&response_type=code&scope=SCOPE&state=STATE#wechat_redirect" />--%>
                        <f:WindowField ColumnID="myWindowField" Width="80px" WindowID="Window1"
                            Icon="Pencil" DataTextFormatString="{0}" DataIFrameUrlFields="tabId,linkPage"
                            DataIFrameUrlFormatString="{1}.aspx?mainId={0}" DataWindowTitleField="viewTyp"

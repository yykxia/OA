...
{
    public partial class BillDetail_ReqList_m : System.Web.UI.Page
    {
        ...
        {
            string sqlCmd = "select A.*,isnull(B.stepName,'已完成') as checkStatus,C.flowName from OA_Bills_Main A";
